    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <?php if (basename($_SERVER['PHP_SELF']) == 'order_read.php') {
                    echo "active";
                ...
                <li class="dropdown"><a class="nav-link 
                <?php if (basename($_SERVER['PHP_SELF']) == 'category_read.php') {
                    echo "active";
                } ?>" href="category_read.php"><span>Category</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="category_read.php">My Category</a></li>
                        <li><a class="nav-link 
                <?php if (basename($_SERVER['PHP_SELF']) == 'category_create.php') {
                    echo "active";
                } ?>" href="category_create.php">Create Category</a></li>
                    </ul>
                </li>

                <li class="dropdown"><a class="nav-link 
                <?php if (basename($_SERVER['PHP_SELF']) == 'customer_read.php') {
                    echo "active";
                } ?>" href="customer_read.php"><span>Customer</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        <li><a href="customer_read.php">My Customers</a></li>
                        <li><a class="nav-link 
                <?php if (basename($_SERVER['PHP_SELF']) == 'customer_create.php') {
                    echo "active";
                } ?>" href="customer_create.php">Create Customer</a></li>
                    </ul>
                </li>
